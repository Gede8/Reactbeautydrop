...
const CartScreen = (navigation) => {
  ...
  const renderCartItem = ({ item }) => (
    <View style={{ flexDirection: 'row', padding: 10, marginBottom: 10,mborderBottomWidth: 1, borderBottomColor: '#ccc' }}>
  ...
  return (
    ...
    fontWeight: 'bold',
    marginTop: 20,
    textAlign: 'right', }}>Total: ${totalPrice.toFixed(2)}</Text>
    </View>
  );
};
